...
if(isset($_POST['btnpotvrdi1']))
{
   ...
   if(count($nizGreske) == 0)
   {
    ...
    //UPDATE `korisnicisajta` SET `ime` = 'Kurcina' WHERE `korisnicisajta`.`idKorisnik` = 48;
    //UPDATE `korisnicisajta` SET `ime` = 'Kllaaafdafa', `prezime` = 'Pdddfafadd', `nadimak` = 'Kdddfsafdd', `email` = 'prsfoba@gmail.com', `sifra` = 'e1f80b90d35d6b551e1af4609f19baa9daeg', `idStatus` = '2', `aktivan` = '0', `pol` = 'Zenskidfg', `aktivacioniKod` = '3299e9b0ccc30f350bd1f6egsdgsc8ed78867dd2c0edd' WHERE `korisnicisajta`.`idKorisnik` = 48;
