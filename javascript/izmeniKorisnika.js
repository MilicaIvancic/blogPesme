...
document.getElementById("izmeniKorisnika").addEventListener("click", proveri);


var regIme = /^[A-ZČĆŽŠĐ][a-zčćžšđ]{2,19}(\s[A-ZČĆŽŠĐ][a-zčćžšđ]{2,19})?$/;
var regPrezime = /^[A-ZČĆŽŠĐ][a-zčćžšđ]{2,19}(\s[A-ZČĆŽŠĐ][a-zčćžšđ]{2,19})?$/;
var regPasword = /^(.){8,35}$/;
